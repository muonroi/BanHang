...
namespace eShopSolution.WebApp.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginRequest request)
        {
            ...
            ClaimsPrincipal userPrincipal = this.ValidateToken(result.ResultObj);
        ...
        [HttpGet]
        public IActionResult RegisterTwo()
        {
            return View();
        }

        [HttpPost]
        public async Task<IActionResult> RegisterTwo(RegisterRequest registerRequest)
        {
